  ...
  return (
    <div className='w-full h-full bg-[#18191A] pt-16'>
      <div className="p-8 max-w-xl mx-auto bg-[#18191A]">
        <h1 className="text-3xl font-bold text-gray-100 mb-4">Cadastrar Funcionário</h1>
        <p className="text-gray-400 mb-6">Preencha os dados abaixo para adicionar um novo funcionário.</p>

        <form onSubmit={handleSubmit} className="space-y-4">
          {['nome', 'funcao', 'horarioTrabalho', 'login', 'senha'].map((field) => (
            <div key={field}>
